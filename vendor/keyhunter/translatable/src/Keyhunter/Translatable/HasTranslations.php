...
use Keyhunter\Translatable\Exception\LocalesNotDefinedException;
...
trait HasTranslations {
    ...
    protected function getLocales()
    {
        ...
        if (empty($locales))
        {
            throw new LocalesNotDefinedException('Please make sure you have included keyhunter/multilingual package and that the languages table is defined and not empty.');
        }
        return $locales;
    }
