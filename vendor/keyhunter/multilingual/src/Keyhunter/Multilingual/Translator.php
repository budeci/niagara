...
use Keyhunter\Multilingual\Contracts\Multilingual;
...
class Translator extends IlluminateTranslator
{
    ...
    /**
     * @var \Keyhunter\Multilingual\Contracts\Multilingual
     */
    ...
    /**
     *
     * @param \Keyhunter\Multilingual\Language $language
    ...
    protected function resolveFromRequest()
    {
        ...
        $this->getActiveLanguages()
            ->each(function ($lang) use (&$activeSlugs) {
                $activeSlugs[] = $lang->slug;
            });
