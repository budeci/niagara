...
use App\CategoryMembershipTranslation;
use App\Contracts\TranslatableRepositoryContract;

class CategoryMembershipRepository extends Repository implements TranslatableRepositoryContract
{
    /**
    ...
    {
        return new CategoryMembership();
    }

    /**
     * @return CategoryMembershipTranslation
     */
    public function getTranslatableModel()
    {
        return new CategoryMembershipTranslation();
    }
