...
use App\CategoryCalcTranslation;
use App\Contracts\TranslatableRepositoryContract;

class CategoryCalcRepository extends Repository implements TranslatableRepositoryContract
{
    /**
    ...
    {
        return new CategoryCalc();
    }

    /**
     * @return CategoryCalcRepository
     */
    public function getTranslatableModel()
    {
        return new CategoryCalcTranslation();
    }
